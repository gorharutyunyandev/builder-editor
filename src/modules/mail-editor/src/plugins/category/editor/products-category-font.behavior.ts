...
import { pebCreateLogger, PebElementStyles, pebFontFamilies, PEB_DEFAULT_FONT_FAMILY } from '@pe/builder-core';
import { PebEditorElement, PebEditorStore, PEB_EDITOR_STATE, SidebarSelectOption } from '@pe/builder-editor';

import { PebMailEditorState } from '../../../mail-editor.state';

const log = pebCreateLogger('mail-editor:plugins:edit-category');
...
export class CategoryFontBehavior {
  ...
  initCategoryFontForm(styles: PebElementStyles, type: CategoryFontTypes): CategoryFont {
