...
import { pebCreateLogger, PebElementStyles, PEB_DEFAULT_FONT_FAMILY } from '@pe/builder-core';
...
const log = pebCreateLogger('mail-editor:plugins:edit-products');
...
export class ProductsFontBehavior {
  ...
  initProductFontForm(styles: PebElementStyles, type: ProductsFontTypes): ProductFont {
