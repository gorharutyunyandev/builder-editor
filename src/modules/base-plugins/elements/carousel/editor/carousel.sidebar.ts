...
import { AbstractComponent, SelectedMedia } from '@pe/builder-editor';
...
export class PebEditorCarouselSidebarComponent extends AbstractComponent implements OnInit {
