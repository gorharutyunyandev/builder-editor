...
import { PebElementShape, PebShapeVariant } from '../client/shape.constants';
...
export class PebEditorShapeSidebarComponent extends SidebarBasic implements OnInit, OnDestroy {
  ...
  private get passStyleFormChangesToOutput(): Array<Observable<any>> {
    return [
