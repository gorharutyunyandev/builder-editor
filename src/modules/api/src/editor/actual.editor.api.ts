...
export class PebActualEditorApi implements PebEditorApi {
  ...
  getSnapshotByVersionId(themeId: PebShopThemeId, versionId: PebShopThemeVersionId): Observable<PebShopThemeSnapshot> {
    return this.http.get<PebShopThemeSnapshot>(`${this.editorApiPath}/api/theme/${themeId}/version/${versionId}/snapshot`);
  }
  ...
  updateReplicas(themeId: string, actions: PebAction[]): Observable<PebShopThemeSnapshot> {
    return this.http.put<PebShopThemeSnapshot>(
