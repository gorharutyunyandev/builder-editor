...
export class MediaService extends PebMediaService {
  ...
  getCategories(): Observable<string[]> {
    return this.http.get<string[]>(`${this.builderMediaPath}/api/selection/categories?type=image`);
  }

  getFormats(): Observable<string[]> {
    return this.http.get<string[]>(`${this.builderMediaPath}/api/selection/formats?type=image`);
  }

  getStyles(): Observable<string[]> {
    return this.http.get<string[]>(`${this.builderMediaPath}/api/selection/styles?type=image`);
  }
